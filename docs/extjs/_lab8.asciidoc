...
[[lab8_start]]
.Start Sencha Architect
image::resources/images/architect_start.png[scale="50"]
...
image::resources/images/architect_setup.png[scale="50"]
...
image::resources/images/architect_tpl1.png[scale="50"]

[[lab8_tpl2]]
.Create custom styles for tpls (part 2)
image::resources/images/architect_tpl2.png[scale="50"]
...
image::resources/images/architect_tpl3.png[scale="75"]
+
[NOTE]
------------------------------------------------------
...
image::resources/images/architect_endresult.png[scale="50"]

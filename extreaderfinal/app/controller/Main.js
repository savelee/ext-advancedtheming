Ext.define('ExtReaderFinal.controller.Main', {
	...
	init: function() {
		...
		ExtReaderFinal.common.Functions.loadTreePanel();
	},
	...
	onMenuSelect: function(tree, rec, i) {
		...
		ExtReaderFinal.common.Functions.setUrl(m.get('link'));
		ExtReaderFinal.common.Functions.getRssFeeds();
	},
